...
const roboImg = document.querySelector('#roboImg');
/* Functions
-------------------------------------------------- */
...
function updateBatteryStatus(battery) {
    ...
    roboimageUrl = `https://robohash.org/${(battery.level * 100)}.png?set=set3`;
    console.log(roboimageUrl);
    roboImg.src = roboimageUrl;
}
